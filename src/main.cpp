...
void add_todo(int todo_length, char **todo, const std::filesystem::path &todo_file);

void del_todo(unsigned int todo_num, const std::filesystem::path &todo_file);

void update_todo(int todo_length, int todo_num, char **update_todo, const std::filesystem::path &todo_file);

void list_todos(const std::filesystem::path &todo_file);

void complete_todo(int todo_num, const std::filesystem::path &todo_file);
...
void del_todo(unsigned int todo_num, const std::filesystem::path &todo_file) {
    ...
    for (const std::string &item: todos) {
        todo_writer << item << "\n";
    }
    todo_writer.close();
}
...
void usage() {
    ...
    printf("del: todo del <todo number>\n");
    printf("done: todo done <todo number>\n");
    printf("update: todo update <todo number> <updated todo>\n");
